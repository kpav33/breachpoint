...
const SOUNDS = {
  ...
  shot_deagle: { vol: 0.6, range: 1300 },
  shot_shotgun: { vol: 0.65, range: 1400 },
  ...
  grenade_throw: { vol: 0.4, range: 500 },
  he_explode: { vol: 0.8, range: 2000 },
  flash_pop: { vol: 0.7, range: 1800 },
  smoke_pop: { vol: 0.55, range: 1000 },
